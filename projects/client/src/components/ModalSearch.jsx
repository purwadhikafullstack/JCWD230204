              ...
              <ul className="text-sm">
                ...
                <li>
                  ...
                  >
                    ...
                    <span>Transaction-Invoices</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Product Update - Q4 2023</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Inventory-Product Stocks</span>
                  </Link>
                </li>
                <li>
                  <Link
              ...
              <ul className="text-sm">
                <li>
                  ...
                  >
                    ...
                    <span><span className="font-medium text-slate-800 group-hover:text-white">Super Admin</span> - Create New Branch Admin </span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span><span className="font-medium text-slate-800 group-hover:text-white">Branch Admin</span> - Request sales report</span>
                  </Link>
                </li>
              </ul>
            </div>
