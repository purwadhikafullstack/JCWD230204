          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Hi, Admin Gamepedia!</span> Cek invoice customermu sekarang~</span>
                <span className="block text-xs font-medium text-slate-400">Apr 4, 2023</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Sales report harian tersedia. </span> Silahkan cek di menu.</span>
                <span className="block text-xs font-medium text-slate-400">Apr 4, 2023</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🚀<span className="font-medium text-slate-800">Jangan lupa istirahat!</span> Kerja keras boleh, sakit keras jangan..</span>
                <span className="block text-xs font-medium text-slate-400">Apr 4, 2023</span>
              </Link>
            </li>
          </ul>
