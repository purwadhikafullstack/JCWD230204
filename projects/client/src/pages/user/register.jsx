...
export default function Register (){
  ...
  return (
    <>
        <div className=" container h-screen flex justify-center align-center items-center bg-[#1c1c1c]">
 
            <div className=" bg-zinc-200 rounded-lg p-10 w-[350px] flex flex-col gap-3 justify-center border border-zinc-500 items-center">
                <h2 className="font-semibold text-2x1 tracking-wide text-center ">REGISTER NOW</h2>
