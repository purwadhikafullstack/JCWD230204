...
import TransactionsTable from '../../partials/transaction/transactiondetail/TransactionsTable';
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-4 md:mb-2">
              ...
              <div className="mb-4 sm:mb-0">
                <h1 className="text-2xl md:text-3xl text-slate-800 font-bold">Rp.250.000.000</h1>
              </div>
            ...
            <div className="mb-5">
              <span>Please, select transaction </span>
              <DropdownTransaction />
            </div>
